...
void testJumble() {
    ...
    JumblePuzzle jp("TEST", "easy");
    cout << "Testing size -> Should be 8: " <<  jp.getSize() << endl;
    cout << "Testing getRow and getCol: Start of word should be at Row: " <<  jp.getRowPos() << " and Col: " << jp.getColPos() << endl;
    cout << "'TEST' should be facing direction: " << jp.getDirection() << endl;
    cout << "Puzzle should be of size: " << jp.getSize() << "x" << jp.getSize() << endl;
    //Show jumble also tests getJumble
    showJumble(jp.getJumble(), jp.getSize());

    //Testing constructor errors:

    //Uncomment to test - displaying of errors disrupts the other testing lines

//    cout << "Testing exception throwing: \n" << endl;
//    try {
//        cout << "Should throw an exception stating that the word is illegal (too short):" << endl;
//        JumblePuzzle jumble("wo", "easy");
//    } catch (BadJumbleException& e) {
//        cerr << e.what() << endl;
//    }

//    try {
//        cout << "Should throw an exception stating that the word is illegal (too long):" << endl;
//        JumblePuzzle jumble1("wordthatistoolong", "hard");
//    } catch (BadJumbleException& e) {
//        cerr << e.what() << endl;
//    }
...
//    try {
//        cout << "Should throw an exception stating that the word is illegal (too long): " << endl;
//        JumblePuzzle jumble2("test", "test");
//    } catch (BadJumbleException& e) {
//        cerr << e.what() << endl;
//    }
